...
GET    /v1/public/stories           # Danh sách truyện (filter, sort, paginate)
GET    /v1/public/stories/{slug}    # Chi tiết truyện + metadata
GET    /v1/public/authors           # Danh sách tác giả
GET    /v1/public/authors/{slug}    # Chi tiết tác giả + stories
GET    /v1/public/categories        # Danh mục/thể loại
GET    /v1/public/trending          # Trending stories (views, ratings)
GET    /v1/public/recommended       # Recommended based on user history

// 1.2 Audio Streaming
GET    /v1/public/stories/{slug}/chapters        # Danh sách chapters
GET    /v1/public/chapters/{id}                  # Chapter details + audio URL
GET    /v1/public/stories/{slug}/chapter/{num}   # Specific chapter
GET    /v1/public/playlists                      # Featured playlists/collections

// 1.3 Search
GET    /v1/public/search                         # Global search (stories, authors)
GET    /v1/public/search/suggestions             # Search suggestions
GET    /v1/public/filters                        # Available filters

// 1.4 Content Management
POST   /v1/public/stories/{id}/view              # Increment view count
POST   /v1/public/stories/{id}/click             # Track clicks
```
...
POST   /v1/user/login                 # Login (email/password, social)
...
POST   /v1/creator/stories            # Create new story
GET    /v1/creator/stories            # Get creator's stories
PUT    /v1/creator/stories/{id}       # Update story
DELETE /v1/creator/stories/{id}       # Delete story (soft delete)
...
POST   /v1/creator/stories/{id}/chapters # Add chapter
GET    /v1/creator/stories/{id}/chapters # Get story's chapters
PUT    /v1/creator/chapters/{id}      # Update chapter
DELETE /v1/creator/chapters/{id}      # Delete chapter
